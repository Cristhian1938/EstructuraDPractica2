...
import Album from 'Frontend/generated/com/unl/hola/base/models/Album';
  ...
  const createAlbum = async () => {
    try {
      if (nombre.value.trim().length > 0) {
        await AlbumServices.create(nombre.value);
        ...
        Notification.show('No se pudo crear, llene la casilla', { duration: 5000, position: 'top-center', theme: 'error' });
      }
    ...
    <>
      ...
      >
        <VerticalLayout style={{ alignItems: 'stretch', width: '18rem', maxWidth: '100%' }}>
          <TextField label="Nombre del Nuevo Album" 
            placeholder="Ingresar el nombre del Album"
